...
- **Configurable status check timeout** — prevents hanging on unreachable servers during status polling (default: 60 s, 0 = unlimited; does not affect Update/Commit)
